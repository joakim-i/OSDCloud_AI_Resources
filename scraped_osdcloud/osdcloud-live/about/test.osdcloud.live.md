> For the complete documentation index, see [llms.txt](https://www.osdcloud.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://www.osdcloud.com/osdcloud-live/about/test.osdcloud.live.md).
...
<figure><img src="/files/COquRKBZMuQDU4bopT79" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/CKLjJi1u46JWTwdaNkBL" alt=""><figcaption></figcaption></figure>
...
<figure><img src="/files/3VijsWvnBTPSaVRI0aAL" alt=""><figcaption></figcaption></figure>
...
```
GET https://www.osdcloud.com/osdcloud-live/about/test.osdcloud.live.md?ask=<question>
```
